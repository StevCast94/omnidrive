...
exports.pushRouter.post('/subscribe', auth_1.authenticate, (0, asyncHandler_1.asyncHandler)(async (req, res) => {
...
exports.pushRouter.delete('/subscribe', auth_1.authenticate, (0, asyncHandler_1.asyncHandler)(async (req, res) => {
